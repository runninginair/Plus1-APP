...
import { findDistance } from "./find-distance.js";


const SearchDistanceScreen = () => {
    const user_Id = 1;
    ...
    return (
        <div>
            <center>
                ...
                <h2>Calculates Distance You've Conquered during a Certain Period:</h2><br />
...
export default SearchDistanceScreen;